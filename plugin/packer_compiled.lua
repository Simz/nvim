...
_G.packer_plugins = {
  ...
  ["cmp-calc"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/cmp-calc",
  ...
  ["formatter.nvim"] = {
    ...
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/formatter.nvim",
    url = "https://github.com/mhartington/formatter.nvim"
  },
  ["git-conflict.nvim"] = {
    config = { 'require("config/git-conflict")' },
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/git-conflict.nvim",
  ...
  ["lightspeed.nvim"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/lightspeed.nvim",
  ...
  ["nvim-dap"] = {
    ...
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/nvim-dap",
    url = "https://github.com/mfussenegger/nvim-dap"
  },
  ["nvim-dap-python"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/nvim-dap-python",
    url = "https://github.com/mfussenegger/nvim-dap-python"
  },
  ["nvim-dap-ui"] = {
    config = { 'require("config/dap-ui")' },
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/nvim-dap-ui",
    url = "https://github.com/rcarriga/nvim-dap-ui"
  },
  ["nvim-dap-virtual-text"] = {
    config = { 'require("config/nvim-dap-text")' },
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/nvim-dap-virtual-text",
  ...
  ["nvim-toggleterm.lua"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/nvim-toggleterm.lua",
  ...
  ["onedarkpro.nvim"] = {
    ...
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/onedarkpro.nvim",
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/popup.nvim",
  ...
  ["vim-graphql"] = {
    loaded = true,
    path = "/home/ec2-user/.local/share/nvim/site/pack/packer/start/vim-graphql",
